                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                        <div>
                            ...
                            <div className='flex w-full justify-between'>
                                ...
                                <span>
                                    <Button /* type="submit" */ onClick={() => setStep(2)} className='w-24 text-white'>
                                        NEXT
                                    </Button>
                                </span>
                            </div>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                        ...
                        <div>
                            ...
                            <div className='w-full justify-evenly flex items-center'>
                                <Button className={`p-4 border-2 bg-transparent border-blue-700 text-blue-700 hover:bg-transparent font-bold ${gender == "male" && 'bg-blue-700 text-white'}`} onClick={() => setGender("male")}>👨 Male</Button>
                                <Button className={`p-4 border-2 bg-transparent border-pink-700 text-pink-700 hover:bg-transparent font-bold ${gender == "female" && 'bg-pink-700 text-white'}`} onClick={() => setGender("female")}>👩 Female</Button>
                            </div>
                            <br />
                            ...
                            <div>
                                ...
                                <div className='flex'>
                                    ...
                                    <span className='flex justify-end'>
                                        <Button /* type="submit" */ onClick={() => setStep(1)} className='w-24'>
